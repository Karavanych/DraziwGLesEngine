...
public class GdxGame extends Game implements ApplicationListener {
	...
	public void create() {
        ...
        Log.d("MyLogs", "ball initial matrix = "+MyMatrix.Matrix4ToString(ball.transform.getValues()));
        
        ball.transform.setToTranslation(0, 9f, 0);
        
        Log.d("MyLogs", "ball after translate = "+MyMatrix.Matrix4ToString(ball.transform.getValues()));
